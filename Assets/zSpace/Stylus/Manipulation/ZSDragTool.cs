...
{  
    ...
    protected void EndDrag()
    {
		...
		{
			velocities[i] = _oldDynamicBodies[i].rigidbody.velocity;
			angularVelocities[i] = _oldDynamicBodies[i].rigidbody.angularVelocity;
		}
        ...
        for (int i = 0; i < _oldDynamicBodies.Count; ++i)
        {
            ...
            if (go != null && go.rigidbody != null)
			{
				...
				go.rigidbody.velocity = velocities[i];
				go.rigidbody.angularVelocity = angularVelocities[i];
			}
        }
